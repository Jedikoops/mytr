...
function handleMouseDown(e) {
  ...
  recentWord = wordBeingMoved
  if(recentWord != null){
    console.log(recentWord)
    recentWord.isSelected = !recentWord.isSelected
  }else{

    console.log("empty selected words")
    selectedWords = []
...
function handleMouseUp(e) {
  ...
  if(recentWord == false){
    ...
    if(recentWord.isSelected == true){
      selectedWords.push(recentWord)
    }else{
      selectedWords.splice(selectedWords.findIndex)
    }
  }
  wasMoved = false
